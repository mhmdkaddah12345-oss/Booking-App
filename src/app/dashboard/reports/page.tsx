              ...
              <>
                ...
                <div className="mt-6 border-t border-zinc-100 pt-4">
                  ...
                  {summary.revenueByService.length === 0 ? (
                    <p className={`mt-2 ${emptyStateClass}`}>{t.noRevenueYet}</p>
                  ) : (
                ...
                <div className="mt-6 border-t border-zinc-100 pt-4">
                  ...
                  {summary.busiestWeekdays.length === 0 ? (
                    <p className={`mt-2 ${emptyStateClass}`}>{t.noBookingsYet}</p>
                  ) : (
                    <ul className="mt-2 flex flex-col gap-1.5">
                      {summary.busiestWeekdays.map((d) => (
                        <li
                          key={d.dayOfWeek}
                          className="flex items-center justify-between rounded-lg bg-zinc-900/[0.06] px-3 py-2 text-sm"
                        >
