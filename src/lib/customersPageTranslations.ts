...
export const customersCopy = {
  en: {
    ...
    filterMinSpentLabel: "Min spent ($)",
    filterMaxSpentLabel: "Max spent ($)",
    filterStatusLabel: "Booking status",
  ...
  ar: {
    ...
    filterMinSpentLabel: "أقل مبلغ ($)",
    filterMaxSpentLabel: "أعلى مبلغ ($)",
    filterStatusLabel: "حالة الحجز",
    filterStatusAll: "أي حالة",
